...
{
	Nokia5110_Clear();
  Nokia5110_OutString("************* WELCOME *************** PRESS SW *************");
}

void fail()
{
	Nokia5110_Clear();
  Nokia5110_OutString("*************** LOSS **************** TRY NEXT **** TIME ***");
	Delay100ms(100);
...
{
	Nokia5110_Clear();
  Nokia5110_OutString("************** CONGRAS ************* PLAY AGAIN ************");
	Delay100ms(100);
